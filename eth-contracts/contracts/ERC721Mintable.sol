...
contract Ownable {
    ...
    event TransferOwnership(address _owner, address newOwner);
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        // make sure the new owner is a real address - IMPLEMENTED IN _transferOwnership
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "Caller is not contract owner"); 
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        Counters.Counter storage counter = _ownedTokensCount[to];
        Counters.increment(counter);
        
        _ownedTokensCount[to] = counter;
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // Decrement oldOwner
        Counters.Counter storage counter = _ownedTokensCount[from];
        Counters.decrement(counter);
        _ownedTokensCount[from] = counter;
        
        // Increment newOwner
        Counters.Counter storage _counter = _ownedTokensCount[to];
        Counters.increment(_counter);
        _ownedTokensCount[to] = _counter;
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function _setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId));
        string memory baseTokenUri = this.baseTokenURI();
        string memory _tokenId = uint2str(tokenId);
        _tokenURIs[tokenId] = strConcat(baseTokenUri, _tokenId, "", "", "");
    }
...
contract ERC721Token is ERC721Metadata("Property Title Token","PTT","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
